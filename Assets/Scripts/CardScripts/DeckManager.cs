    ...
    private void SetCardData(CardContainerData data, int index)
    {
        switch (index % 10)
        {
            ...
            case 1:
                ...
                data.manaCost = 1;
                data.cardDmg = 25f + PlayerBridgeData.Instance.dmgBoost + 3; 
                data.cardId = 1;
                data.cardEffect = "SPIRIT SPELL: +I MANA";
                break;
            case 2:
            ...
            case 4:
                ...
                data.manaCost = 4;
                data.cardDmg = 45f + PlayerBridgeData.Instance.dmgBoost + 3; 
                data.cardId = 4;
                data.cardEffect = "SPIRIT SPELL: +I MANA";
                break;
            case 5:
                ...
                data.manaCost = 5;
                data.cardDmg = 70f + PlayerBridgeData.Instance.dmgBoost + 3; 
                data.cardId = 5;
            ...
            case 9:
                ...
                data.manaCost = 7;
                data.cardDmg = 85f + PlayerBridgeData.Instance.dmgBoost + 3; 
                data.cardId = 9;
